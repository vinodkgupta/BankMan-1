...
$query1="INSERT INTO Transactions(Trans_id,Date,Acc_no,Remark,Amount,Emp_id) VALUES('$Trans_id','$date','$acc_no','$remark','$amount','$Emp_id/$Man_id')";
...
$query5="UPDATE Transaction_count SET Trans_count=Trans_count+1";
			...
			if($query1_data=mysql_query($query1) && $query2_data=mysql_query($query2) ){
				...
				echo '<span style="color:#720707;"><h2>Successful</h2>';//.$query1_data;
